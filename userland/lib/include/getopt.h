...
struct option
{
    ...
    /*
     * Determines if getopt_long() returns a value for a long option; if it is
     * non-NULL, 0 is returned as a function value and the value of val is
     * stored in the area pointed to by flag.  Otherwise, val is returned.
     */
    int *flag;
...
int __getopt_long_only_r(int __argc, char *const __argv[],
